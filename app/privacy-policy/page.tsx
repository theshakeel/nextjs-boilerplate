        ...
        <>
          ...
          <ul className="list-disc list-inside mt-3 space-y-1 text-gray-300">
            ...
            <li>
              ...
              and authentication keys-sessions.
            </li>
            <li>
            ...
            <li>
              <strong>Payment Information:</strong> Payments are securely processed by Stripe. We do not store your card details; only a unique encrypted transaction reference generated by Stripe is retained.
            </li>
            <li>
    ...
    },
    {
      ...
      content: (
        <div className="text-gray-300 space-y-2">
          ...
          <p>
            📧 <a href="mailto:privacy@xhospital.org" className="text-cyan-400">privacy@xhospital.net</a>
          </p>
          <p>📞 +1 815-982-3054</p>
        </div>
      ),
